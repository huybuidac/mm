...
export interface NftPositionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
...
export interface NftPosition extends BaseContract {
  connect(runner?: ContractRunner | null): NftPosition;
  waitForDeployment(): Promise<this>;

  interface: NftPositionInterface;
